...
Thank you to **@awprice** for the Rovo Dev runner, **@koshimazaki** for review persona rotation, and **@sims1253** for the R language coverage work. Thanks also to the reporters behind the runner, Rust, TypeScript, state-repair, and constrained-host issues that shaped this 1.0 stabilization pass.
